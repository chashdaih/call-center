...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <h1>{{ __('Edit Caller') }}</h1>
            <div class="card">
                <div class="card-header">{{ __('Edit') }}</div>
                <div class="card-body">
                    <form method="POST" action="{{ route('callers.update', $caller->id) }}">
                        @csrf
                        @method('PATCH')
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text"
                                 ...
                                 name="name" value="{{ $caller->name }}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="last_name" type="text"
                                 ...
                                 name="last_name" value="{{ $caller->last_name}}"  required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="age" type="number" min="0" max="127"
                                 ...
                                 name="age" value="{{ $caller->age }}"  required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="phone_number" type="tel" 
                                 ...
                                 name="phone_number" value="{{ $caller->phone_number }}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="other_phone_number" type="tel" 
                                 ...
                                 name="other_phone_number" value="{{ $caller->other_phone_number }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="state_id"
                                 ...
                                 name="state_id" value="{{ $caller->state->id }}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="city" type="text"
                                 ...
                                 name="city" value="{{ $caller->city }}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="file_number" type="number"
                                 ...
                                 name="file_number" value="{{ $caller->file_number }}" required>
