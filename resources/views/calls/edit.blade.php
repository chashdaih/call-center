                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="date" type="date"
                                 ...
                                 name="date" value="{{ $call->date }}" required >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="schedule_id"
                                 ...
                                 name="schedule_id" value="{{ $call->schedule->id }}" required>
                                    @foreach ($schedules as $schedule)
                                    <option {{ $schedule->id == $call->schedule->id ? 'selected' : '' }}
                            ...
                            <div class="col-md-6">
                                <select id="office_id"
                                 ...
                                 name="office_id" value="{{ old('office_id') }}" required>
                                    ...
                                    <option {{ $office->id == $call->cubicule->office->id ? 'selected' : '' }}
                            ...
                            <div class="col-md-6">
                                <select id="cubicule_id"
                                 ...
                                 name="cubicule_id" value="{{ old('cubicule_id') }}" required>
                                    ...
                                    <option {{ $cubicule->id == $call->cubicule->id ? 'selected' : '' }}
                                     value="{{ $cubicule->id }}">{{ $cubicule->name }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6">
                                <select id="student_id"
                                 ...
                                 name="student_id" value="{{ old('student_id') }}" required>
                                    ...
                                    <option {{ $student->id == $call->student->id ? 'selected' : '' }}
                                     value="{{ $student->id }}">{{ $student->name.' '.$student->last_name }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6">
                                <select id="caller_id"
                                 ...
                                 name="caller_id" value="{{ old('caller_id') }}" required>
                                    ...
                                    <option {{ $caller->id == $call->caller->id ? 'selected' : '' }}
                                    value="{{ $caller->id }}">{{ $caller->name.' '.$caller->last_name }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6">
                                <select id="reason_id"
                                 ...
                                 name="reason_id" value="{{ old('reason_id') }}" required>
                                    ...
                                    <option {{ $reason->id == $call->reason->id ? 'selected' : '' }}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="observation" 
                                 ...
                                 name="observation" value="{{ $call->observation }}" ></textarea>
